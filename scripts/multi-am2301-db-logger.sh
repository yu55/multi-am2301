...
sqlite3 /var/local/am2301-db.sl3 "INSERT INTO pin23 VALUES('$DATETIME', '$T', '$RH');";
...
sqlite3 /var/local/am2301-db.sl3 "INSERT INTO root_cellar VALUES('$DATETIME', '$T', '$RH');";
...
sqlite3 /var/local/am2301-db.sl3 "INSERT INTO pin25 VALUES('$DATETIME', '$T', '');";
